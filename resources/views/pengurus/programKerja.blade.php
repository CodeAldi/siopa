        ...
        <form class="modal-content" action="{{ route('pengurus.programKerja.update') }}" method="POST">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col mb-3">
                        <label for="lokasi" class="form-label">lokasi kegiatan</label>
                        <input type="text" id="Editlokasi" class="form-control" name="lokasi" autofocus required />
                    </div>
                </div>
                <div class="row">
                    <div class="col mb-3">
                        <label for="tanggal" class="form-label">tanggal kegiatan</label>
                        <input type="date" id="Edittanggal_kegiatan" class="form-control" name="tanggal_kegiatan" required />
                    </div>
                </div>
                <div class="row">
                    <div class="col mb-3">
